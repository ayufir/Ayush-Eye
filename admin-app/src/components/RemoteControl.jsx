        ...
        <div className={`fixed inset-0 z-50 bg-black flex flex-col ${isFullscreen ? '' : ''}`}>
            ...
            <div className="h-12 bg-slate-900 border-b border-slate-700 flex items-center justify-between px-4 flex-shrink-0">
                ...
                <div className="flex items-center gap-2">
                    ...
                    <button title="Remote Mouse" className="p-1.5 hover:bg-slate-700 rounded text-slate-400 hover:text-blue-400 text-xs">
                        <MousePointer size={15} />
                    </button>
                    <button title="Remote Keyboard" className="p-1.5 hover:bg-slate-700 rounded text-slate-400 hover:text-blue-400">
                        <Keyboard size={15} />
                    </button>
                    <button title="Screenshot" className="p-1.5 hover:bg-slate-700 rounded text-slate-400 hover:text-amber-400">
                        <Camera size={15} />
                    </button>
                    <div className="w-px h-5 bg-slate-700 mx-1" />
                    <button
